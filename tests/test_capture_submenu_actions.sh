...
grep -q 'Watch video' src/uis/web/pages/index.vue || fail "web UI must expose watch video action"
grep -q 'Preparing video' src/uis/web/pages/index.vue || fail "web UI must show conversion-before-watch feedback"
