...
grep -q 'Record fmt' src/uis/oled/screens.py || fail "OLED settings must expose recording format"
...
grep -q 'Recording format' src/uis/web/pages/index.vue || fail "web UI must expose recording format setting"
